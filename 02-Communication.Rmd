...
I believe this is more or less self-explanatory. My advice would be to change the date to: *"`r Sys.Date()`"* so that the date automatically updates to the time you **knit** the document.

...
intro_data = data.frame(
  ...
  mytext_name = c("","","","","","","","","","","","","","","", "", "", "", "Made by \n Gillian Debra" ,rep("Made by \n Gillian Debra",each = 1)  ),
  mytext_essentials = c("","","","","C","CO","COR","CORE","CORE \n B","CORE \n BA","CORE \n BAS","CORE \n BASI","CORE \n BASIC","CORE \n BASICS", "CORE \n BASICS \n UN", "CORE \n BASICS \n UNLEASH", rep("CORE \n BASICS \n UNLEASHED", each = 4)    )
...
myplot = intro_data %>% 
  ...
  geom_text(aes(label = mytext_essentials), x = 4, y = 3, size = 12, color = "black", alpha = 0.9) +
  geom_text(aes(label=mytext_name),x=4, y=1.75, size =12, color="black", apha = 0.8) +
  theme_void() +
  theme(legend.position = "None") +
  transition_reveal(along = move)  

animate(myplot, duration = 5, fps = 10, end_pause = 13)  
```

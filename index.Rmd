...
myplot = intro_data %>% 
  ...
  geom_text(aes(label = mytext_essentials), x = 4, y = 3, size = 10, color = "black", alpha = 0.9) +
  geom_text(aes(label=mytext_name),x=4, y=1.75, size =10, color="black", apha = 0.8) +
  theme_void() +
  theme(legend.position = "None") +
  transition_reveal(along = move)  

animate(myplot, duration = 5, fps = 10, end_pause = 14)  
```
